...
const CityList: any[] = [
  ...
  { value: 910000, label: "保加利亚" },
  { value: 910400, label: "缅甸" },
  { value: 910800, label: "布隆迪" },
  { value: 911200, label: "白俄罗斯" },
  { value: 911600, label: "柬埔寨" },
  { value: 912000, label: "喀麦隆" },
  { value: 912400, label: "加拿大" },
  { value: 913200, label: "佛得角" },
  { value: 913600, label: "开曼群岛" },
  { value: 914000, label: "中非" },
  { value: 914400, label: "斯里兰卡" },
  { value: 914800, label: "乍得" },
  { value: 915200, label: "智利" },
  { value: 916200, label: "圣诞岛" },
  { value: 916600, label: "科科斯群岛" },
  { value: 917000, label: "哥伦比亚" },
  { value: 917400, label: "科摩罗" },
  { value: 917500, label: "马约特" },
  { value: 917800, label: "刚果（布）" },
  { value: 918000, label: "刚果（金）" },
  { value: 918400, label: "库克群岛" },
  { value: 918800, label: "哥斯达黎加" },
  { value: 919100, label: "克罗地亚" },
  { value: 919200, label: "古巴" },
  { value: 919600, label: "塞浦路斯" },
  { value: 920300, label: "捷克" },
  { value: 920400, label: "贝宁" },
  { value: 920800, label: "丹麦" },
  { value: 921200, label: "多米尼克" },
  { value: 921400, label: "多米尼加" },
  { value: 921800, label: "厄瓜多尔" },
  { value: 922200, label: "萨尔瓦多" },
  { value: 922600, label: "赤道几内亚" },
  { value: 923100, label: "埃塞俄比亚" },
  { value: 923200, label: "厄立特里亚" },
  { value: 923300, label: "爱沙尼亚" },
  { value: 923400, label: "法罗群岛" },
  { value: 923800, label: "马尔维纳斯群岛（ 福克兰）" },
  { value: 923900, label: "南乔治亚岛和南桑威奇群岛" },
  { value: 924200, label: "斐济群岛" },
  { value: 924600, label: "芬兰" },
  { value: 924800, label: "奥兰群岛" },
  { value: 925000, label: "法国" },
  { value: 925400, label: "法属圭亚那" },
  { value: 925800, label: "法属波利尼西亚" },
  { value: 926000, label: "法属南部领地" },
  { value: 926200, label: "吉布提" },
  { value: 926600, label: "加蓬" },
  { value: 926800, label: "格鲁吉亚" },
  { value: 927000, label: "冈比亚" },
  { value: 927500, label: "巴勒斯坦" },
  { value: 927600, label: "德国" },
  { value: 928800, label: "加纳" },
  { value: 929200, label: "直布罗陀" },
  { value: 929600, label: "基里巴斯" },
  { value: 930000, label: "希腊" },
  { value: 930400, label: "格陵兰" },
  { value: 930800, label: "格林纳达" },
  { value: 931200, label: "瓜德罗普" },
  { value: 931600, label: "关岛" },
  { value: 932000, label: "危地马拉" },
  { value: 932400, label: "几内亚" },
  { value: 932800, label: "圭亚那" },
  { value: 933200, label: "海地" },
  { value: 933400, label: "赫德岛和麦克唐纳群岛" },
  { value: 933600, label: "梵蒂冈" },
  { value: 934000, label: "洪都拉斯" },
  { value: 934800, label: "匈牙利" },
  { value: 935200, label: "冰岛" },
  { value: 935600, label: "印度" },
  { value: 936000, label: "印尼" },
  { value: 936400, label: "伊朗" },
  { value: 936800, label: "伊拉克" },
  { value: 937200, label: "爱尔兰" },
  { value: 937600, label: "以色列" },
  { value: 938000, label: "意大利" },
  { value: 938400, label: "科特迪瓦" },
  { value: 938800, label: "牙买加" },
  { value: 939200, label: "日本" },
  { value: 939800, label: "哈萨克斯坦" },
  { value: 940000, label: "约旦" },
  { value: 940400, label: "肯尼亚" },
  { value: 940800, label: "朝鲜 北朝鲜" },
  { value: 941000, label: "韩国" },
  { value: 941400, label: "科威特" },
  { value: 941700, label: "吉尔吉斯斯坦" },
  { value: 941800, label: "老挝" },
  { value: 942200, label: "黎巴嫩" },
  { value: 942600, label: "莱索托" },
  { value: 942800, label: "拉脱维亚" },
  { value: 943000, label: "利比里亚" },
  { value: 943400, label: "利比亚" },
  { value: 943800, label: "列支敦士登" },
  { value: 944000, label: "立陶宛" },
  { value: 944200, label: "卢森堡" },
  { value: 945000, label: "马达加斯加" },
  { value: 945400, label: "马拉维" },
  { value: 945800, label: "马来西亚" },
  { value: 946200, label: "马尔代夫" },
  { value: 946600, label: "马里" },
  { value: 947000, label: "马耳他" },
  { value: 947400, label: "马提尼克" },
  { value: 947800, label: "毛里塔尼亚" },
  { value: 948000, label: "毛里求斯" },
  { value: 948400, label: "墨西哥" },
  { value: 949200, label: "摩纳哥" },
  { value: 949600, label: "蒙古国" },
  { value: 949800, label: "摩尔多瓦" },
  { value: 949900, label: "黑山" },
  { value: 950000, label: "蒙塞拉特岛" },
  { value: 950400, label: "摩洛哥" },
  { value: 950800, label: "莫桑比克" },
  { value: 951200, label: "阿曼" },
  { value: 951600, label: "纳米比亚" },
  { value: 952000, label: "瑙鲁" },
  { value: 952400, label: "尼泊尔" },
  { value: 952800, label: "荷兰" },
  { value: 953300, label: "阿鲁巴" },
  { value: 953500, label: "荷兰加勒比区" },
  { value: 954000, label: "新喀里多尼亚" },
  { value: 954800, label: "瓦努阿图" },
  { value: 955400, label: "新西兰" },
  { value: 955800, label: "尼加拉瓜" },
  { value: 956200, label: "尼日尔" },
  { value: 956600, label: "尼日利亚" },
  { value: 957000, label: "纽埃" },
  { value: 957400, label: "诺福克岛" },
  { value: 957800, label: "挪威" },
  { value: 958000, label: "北马里亚纳群岛" },
  { value: 958100, label: "美国本土外小岛屿" },
  { value: 958300, label: "密克罗尼西亚联邦" },
  { value: 958400, label: "马绍尔群岛" },
  { value: 958500, label: "帕劳" },
  { value: 958600, label: "巴基斯坦" },
  { value: 959100, label: "巴拿马" },
  { value: 959800, label: "巴布亚新几内亚" },
  { value: 960000, label: "巴拉圭" },
  { value: 960400, label: "秘鲁" },
  { value: 960800, label: "菲律宾" },
  { value: 961200, label: "皮特凯恩群岛" },
  { value: 961600, label: "波兰" },
  { value: 962000, label: "葡萄牙" },
  { value: 962400, label: "几内亚比绍" },
  { value: 962600, label: "东帝汶" },
  { value: 963000, label: "波多黎各" },
  { value: 963400, label: "卡塔尔" },
  { value: 963800, label: "留尼汪" },
  { value: 964200, label: "罗马尼亚" },
  { value: 964300, label: "俄罗斯" },
  { value: 964600, label: "卢旺达" },
  { value: 965200, label: "圣巴泰勒米岛" },
  { value: 965400, label: "圣赫勒拿" },
  { value: 965900, label: "圣基茨和尼维斯" },
  { value: 966000, label: "安圭拉" },
  { value: 966200, label: "圣卢西亚" },
  { value: 966300, label: "法属圣马丁" },
  { value: 966600, label: "圣皮埃尔和密克隆" },
  { value: 967000, label: "圣文森特和格林纳丁斯" },
  { value: 967400, label: "圣马力诺" },
  { value: 967800, label: "圣多美和普林西比" },
  { value: 968200, label: "沙特阿拉伯" },
  { value: 968600, label: "塞内加尔" },
  { value: 968800, label: "塞尔维亚" },
  { value: 969000, label: "塞舌尔" },
  { value: 969400, label: "塞拉利昂" },
  { value: 970200, label: "新加坡" },
  { value: 970300, label: "斯洛伐克" },
  { value: 970400, label: "越南" },
  { value: 970500, label: "斯洛文尼亚" },
  { value: 970600, label: "索马里" },
  { value: 971000, label: "南非" },
  { value: 971600, label: "津巴布韦" },
  { value: 972400, label: "西班牙" },
  { value: 972800, label: "南苏丹" },
  { value: 972900, label: "苏丹" },
  { value: 973200, label: "西撒哈拉" },
  { value: 974000, label: "苏里南" },
  { value: 974400, label: "斯瓦尔巴群岛和 扬马延岛" },
  { value: 974800, label: "斯威士兰" },
  { value: 975200, label: "瑞典" },
  { value: 975600, label: "瑞士" },
  { value: 976000, label: "叙利亚" },
  { value: 976200, label: "塔吉克斯坦" },
  { value: 976400, label: "泰国" },
  { value: 976800, label: "多哥" },
  { value: 977200, label: "托克劳" },
  { value: 977600, label: "汤加" },
  { value: 978000, label: "特立尼达和多巴哥" },
  { value: 978400, label: "阿联酋" },
  { value: 978800, label: "突尼斯" },
  { value: 979200, label: "土耳其" },
  { value: 979500, label: "土库曼斯坦" },
  { value: 979600, label: "特克斯和凯科斯群岛" },
  { value: 979800, label: "图瓦卢" },
  { value: 980000, label: "乌干达" },
  { value: 980400, label: "乌克兰" },
  { value: 980700, label: "马其顿" },
  { value: 981800, label: "埃及" },
  { value: 982600, label: "英国" },
  { value: 983100, label: "根西岛" },
  { value: 983200, label: "泽西岛" },
  { value: 983300, label: "马恩岛" },
  { value: 983400, label: "坦桑尼亚" },
  { value: 984000, label: "美国" },
  { value: 985000, label: "美属维尔京群岛" },
  { value: 985400, label: "布基纳法索" },
  { value: 985800, label: "乌拉圭" },
  { value: 986000, label: "乌兹别克斯坦" },
  { value: 986200, label: "委内瑞拉" },
  { value: 987600, label: "瓦利斯和富图纳" },
  { value: 988200, label: "萨摩亚" },
  { value: 988700, label: "也门" },
  { value: 989400, label: "赞比亚" },
];
...
const AreaData: any[] = [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        value: 360500,
        label: "新余市",
        children: [{ value: 360521, label: "分宜县" }],
      },
      {
        value: 360600,
        label: "鹰潭市",
  ...
  },
  {
    ...
    children: [
      ...
      { value: 419000, label: "省直辖县", children: [] },
    ],
  },
  {
    value: 420000,
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        value: 620300,
        label: "金昌市",
        children: [{ value: 620321, label: "永昌县" }],
      },
      {
        value: 620400,
        label: "白银市",
...
export function getAreaData(): any[] {
  // let provinceData = ProvinceList;
  // let cityData = CityList;
  // let countData = CountyList;
  // countData.forEach((count, countKey) => {
  //   let countId = count.value.toString();
  //   cityData.forEach((city, ckey) => {
  //     let cityId = city.value.toString();
  //     if (countId.substring(0, 4) == cityId.substring(0, 4)) {
  //       if (city.children) {
  //         city.children.push(count);
  //       } else {
  //         city.children = [];
  //       }
  //     }
  ...
  // cityData.forEach((city, ckey) => {
  //   let cityId = city.value.toString();
  //   provinceData.forEach((prov, pkey) => {
  //     let provId = prov.value.toString();
  //     if (provId.substring(0, 2) == cityId.substring(0, 2)) {
  //       if (prov.children) {
